...
**Team Seapsychos** 
- **1st Place Award**
- Members: Eric Richardson, Raymond Luong, V. Sebastian Utama
- Mentor: Xuesong Ding
- Project: Earth Surface Change Over Time in Response to Sea-Level Changes
- Repository: https://github.com/e-rich18/seapsycho/tree/main

**Team Alphateam**
- **2nd Place Award**
- Members: Xihan Yao, Koutian Wu, Rushi Bhatt
- Mentor: Brendon Hall
...
- Members: Sabrina Reichert, Vineet Burugu, Manoj Kumar
- Mentor: 
...
- Repository: https://github.com/vineet640/geoscience_hackathon.git

**Team G3**
- Members: Fehmi Ozbayrak, Yevgeny Samarkin
- Mentor: Ben Lasscock, Brendon Hall
